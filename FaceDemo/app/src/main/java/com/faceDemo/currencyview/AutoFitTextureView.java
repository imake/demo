...
public class AutoFitTextureView extends TextureView {
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        final int width = 480;//getResources().getDisplayMetrics().widthPixels;//取得屏幕分辨率
        final int height =640; //getResources().getDisplayMetrics().heightPixels;

        //width=1080 height=1792
        Log.d("onMeasure", "onMeasure: width="+width+" height="+height);
